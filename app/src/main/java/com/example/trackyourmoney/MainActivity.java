...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_home, R.id.nav_analyse, R.id.nav_fixkosten, R.id.nav_ausgaben, R.id.nav_fixkosten_aendern, R.id.nav_budget_aendern, R.id.nav_ausgabe_hinzufuegen, R.id.nav_einnahme_hinzufuegen, R.id.nav_ausgabenlimit_aendern)
